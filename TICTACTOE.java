...
class TicTacToeGameinSwing implements ActionListener
{
    ...
    TicTacToeGameinSwing(String p1,String  p2)
    {
        this.p1 = p1;
        this.p2 = p2;
    ...
    public void startGame()
    {
        ...
        {
            pl1_chance = true;
            textfield.setText("Player "+p1+" turn");

        }
        else
        {
            pl1_chance = false;
            textfield.setText("Player "+p2+" turn");
        }
    }
    ...
    public void gameOver(String s)
    {
        ...
        if(n==0)
        {
            ...
            String kk = p1;
                    String kkj = p2;
            new TicTacToeGameinSwing(kk,kkj);
        }
        else
        {
            frame.dispose();
    ...
    public void xWins(int x1, int x2, int x3)
    {
        ...
        textfield.setText("Player "+p1+" wins");
    ...
    public void oWins(int x1, int x2, int x3)
    {
        ...
        textfield.setText("Player"+p2+" Wins");
        gameOver("Player"+p2+" Wins");
    }
